...
const OurServicesSection = () => {
	return (
		<div className="mx-auto md:px-0 px-4 flex flex-row flex-wrap md:mt-[100px] mt-[60px] justify-center items-center">
			<div className="md:w-4/12 w-full p-8 flex flex-col">
				<img
